...
ShadowGraph is yet another YouTube copy written with Ruby on Rails. It succeed Video-App by <a href = "http://ralphedge.com">Ralph Edge</a> and inspired by <a href = "http://pandastream.com">Panda</a>.
